            ...
            <div class="overflow-auto" style="height: 12rem;">
                ...
                <table class="table table-hover table-light table-bordered">
                    ...
                    <tbody>
                        ...
                        @foreach($data2 as $grup)

                        <tr>
                           

                            <td><a style="border:none;" href="{{ url('/radiologi/group/edit') }}/{{$grup->idgrup}}" class="btn"> {{$grup->grup}}</a></td>
        ...
        <div class="col-4 mt-3">
            ...
            <form action="" method="post">
                ...
                <div class="m-2">
                    ...
                    <input type="text" name="grup" style="width: 100%;" value="{{$data->grup}}">
