...
grid-template-columns: 70% 30%">
    ...
    <form action="{{ route('itemTest') }}" method="get" class="row g-3 align-items-center" id="formSearch" style="float:">
        ...
        <div class="col-3">
            ...
            <div class="row" style="padding-top: 3%">
                ...
                <div class="col-auto">
                    ...
                    <a href="{{ route('btnIT', ['id' => '#', 'sendG' => '#', 'button' => 'create']) }}" style="text-decoration: none;">
                    ...
                    <a href="{{ route('btnIT', ['id' => $value1, 'sendG' => $value10, 'button' => 'edit']) }}" style="text-decoration: none;">
                    ...
                    <a href="{{ route('btnIT', ['id' => $value1, 'sendG' => $value10, 'button' => 'delete']) }}" style="text-decoration: none;">
    ...
    <div class="row">
        ...
        <div class="col-8">
            ...
            <Table class="table table-bordered align-middle" style="background-color: #ffffff;text-align: center;vertical-align: midle;margin-left:2%">
                ...
                <form action="{{ route('showIT',['id'=>$a->iditemekg,'idg'=>$a->idgrup]) }}" method="post">
         ...
         @if (ISSET($btn))
             ...
             @switch($btn)
                ...
                @case('1')
                 ...
                 <form action="{{ route('createIT') }}" method=post name=formIT id=formIT>
                    ...
                    <div style="margin-left: 2%">
                            ...
                            <div class="col-4">
                                ...
                                <div class="m-2">
                                    ...
                                    <input type=hidden name=idG id="sendGroup" value='{{ $value10 }}'>

                                    <label>Group</label><br>

                                    <input required  onkeydown="return false;" type="text" class="" style="width: 85%;" name=grup id=sendIdG value="{{ $value9 }}">
                ...
                @case('2')
                    ...
                    <form action="{{ route('editIT', ['id' => $value1, 'idg' => $value10]) }}" method=post name=formIT id=formIT>
                    ...
                    <div style="margin-left: 2%">
                            ...
                            <div class="col-4">
                                ...
                                <div class="m-2">
                                    ...
                                    <input readonly type="text" class="" style="width: 85%;" name=grup id=sendIdG value="{{ $value9 }}">
                ...
                @case('3')
                    ...
                    <form action="{{ route('deleteIT', ['id' => $value1, 'idg' => $value10]) }}" method=post name=formIT id=formIT>
                    ...
                    <div style="margin-left: 2%">
                            ...
                            <div class="col-4">
                                ...
                                <div class="m-2">
                                    ...
                                    <input disabled readonly type="text" class="" style="width: 85%;" name=grup id=sendIdG value="{{ $value9 }}">
...
<script>
    ...
    window.closeModal1 = function(){
        $('#popupGtIT').modal('hide');
    };
    window.closeModal2 = function(){
        $('#popupGtITE').modal('hide');
    };

    function sendGroup(id, grup){
        document.getElementById('sendIdG').value=grup;
        document.getElementById('sendGroup').value=id;
    }
