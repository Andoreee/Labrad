    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-body">
            <iframe src="{{ route('windowsPP') }}" frameborder="0" width="1105" height="670"></iframe>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="col-8" style="">
                ...
                <div class="row">
                    ...
                    <div class="col-6 mt-3">
                        ...
                        <div style="margin-left: 10px;background-color: #ffffff;overflow-y:hidden;height: 200px">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="idit" id="sendId">
                                            <input type="" style="width:100%" readonly class="inputable" id="sendItemTest" name="It" onfocus="btnitem()">
                                            <button type="button" id="itembtn" style="float: right;display:none;" data-bs-toggle="modal" data-bs-target="#itemtest">...</button>
                                        </td>
                                        <td>
                                            <input type="number" style="width:100%;display:block" class="inputable" id="biayaRJ" value="" name="biayaRJ" id="changeToZero" onfocus="btnitemNot()">
                                            <input type="number" style="width:100%;display:none" class="inputable" id="biayaPL" value="" name="biayaPL" id="changeToZero" onfocus="btnitemNot()">
                                        </td>
                                        <td>
                                            <input type="number" style="width:100%" class="inputable" name="kv" id="changeToZero1" onfocus="btnitemNot()">
                                        </td>
                                        <td>
                                            <input type="number" style="width:100%" class="inputable" name="mas" id="changeToZero2" onfocus="btnitemNot()">
                                        </td>
                                        <td>
                                            <input type="number" style="width:100%" class="inputable" name="expose" id="changeToZero3" onfocus="btnitemNot()">
                                        </td>
                                        <script>
                                            var a = document.getElementById("itembtn");
                                            var b = document.getElementById("sendItemTest");
                                            function btnitem(){a.style.display = "block";b.style.width = "70%";}
                                            function btnitemNot(){a.style.display = "none";b.style.width = "100%";}
                                            window.changetozero = function(){
                                                $("#changeToZero1").val(0);
                                                $("#changeToZero2").val(0);
                                                $("#changeToZero3").val(0);
                                                document.getElementById("filmrow").style.display= "table-row";
                                            };
                                        </script>
                                    </tr>
                                    ...
                                    <tr style="" id="filmrow">
                                        ...
                                        <td>
                                          <select name="film" id="film">
                                            <option value=""></option>
                                            @foreach ($film as $a)
                                            <option value="{{ $a->idfilm }}">{{ $a->namafilm }}</option>
                                            @endforeach
                                          </select>
...
{{-- POP UP DISINI --}}
    ...
    <script>
        ...
        function sendItemTest(id, it, bRJ, bPL){
            document.getElementById('sendId').value=id;
            document.getElementById('sendItemTest').value=it;
                document.getElementById('biayaPL').value=bPL;
                document.getElementById('biayaRJ').value=bRJ;
        }
        ...
        var update_select = function () {
            ...
            if ($('#pl').is(':checked')) {
                ...
                document.getElementById("biayaPL").style.display = 'block';
                document.getElementById("biayaRJ").style.display = 'none';
                ...
                document.getElementById("biayaPL").style.display = 'none';
                document.getElementById("biayaRJ").style.display = 'block';
            }
